        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TimeSlots_EndAfterStart", "[EndUtc] > [StartUtc]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Bookings_TimeSlotId",
                table: "Bookings",
                column: "TimeSlotId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TimeSlots_ResourceId_StartUtc",
                table: "TimeSlots",
                columns: new[] { "ResourceId", "StartUtc" });

            migrationBuilder.CreateIndex(
                name: "UX_TimeSlots_ResourceId_StartUtc_EndUtc",
                table: "TimeSlots",
